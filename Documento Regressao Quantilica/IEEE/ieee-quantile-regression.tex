...
Let a dataset be composed of $n$ observations of $\{y_t,x_t \}_{t=1}^n$. In order to calculate a sample quantile based on this finite number of observations, instead of integrating over all domain of random variable $Y$\todo{Definir $Y_t$ no lugar de $Y$?}, we sum individual ... is given by 
\begin{eqnarray}
