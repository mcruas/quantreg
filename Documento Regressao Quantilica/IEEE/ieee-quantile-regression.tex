...
\hat{Q}_{Y|X}(\alpha,\cdot)\quad\in\quad  \underset{q_{\alpha}}{\text{arg min}}\, L(\alpha) = \sum_{t\in T}\rho_{\alpha}(y_{t}-q_{\alpha}(x_t)),\label{eq:optim-lqr1} \\
