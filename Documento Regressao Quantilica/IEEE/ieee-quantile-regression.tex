...
Let a dataset be composed of $n$ observations of $\{y_t,x_t \}$. To calculate the sample quantile, the optimization based on this finite number of observations, instead of integrating over all domain of random variable $Y$\todo{Definir $Y_t$ no lugar de $Y$?}.
