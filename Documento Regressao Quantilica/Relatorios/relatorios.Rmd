...
- Quantile regression is one technique available to estimate the distribution of $\varepsilon_t$, by estimating a phin grid of $\alpha$-quantiles at once.

- We explore different strategies of estimating the Conditional Quantile Regression focused on approaching the distribution of $\varepsilon_t$ (or $y_{t+k|t}$).
